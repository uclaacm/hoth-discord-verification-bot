module.exports = {
  ...
  discord: {
    server_id: '798314242004615230',
    verified_role_name: 'verified',
    mod_role_name: 'admin',
    alumni_role_name: 'verified',
  },
  sendgrid: {
  ...
  default_msgs: {
    welcome: `
Welcome to the **ACM Hack HOTH 8** Discord community!

To keep the server a safe place for our hackers, please verify yourself using your email address.

**By verifying, you agree to our rules and guidelines posted in #rules **
To obtain your verification code, reply to this message with the following command:
\`\`\`MD
!iam <affiliation> <name> <ucla_email>
\`\`\`
Make sure to leave the angular brackets out. e.g.,
\`\`\`MD
!iam student joe bruin joebruin@g.ucla.edu
\`\`\`
`,
  },
  majors_list: [
